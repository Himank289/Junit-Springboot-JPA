...
public class GreetRestService {
	...
	//@RequestMapping (value="hello",method=RequestMthod.Get)
	@GetMapping("hello")
	...
	@DeleteMapping("emp")
	public boolean delEmp(@RequestBody Employee e)
	{
		return this.empdao.removeEmp(e);
	}
	
	@PutMapping("emp")
	public boolean updateEmp(@RequestBody Employee e)
	{
		return this.empdao.updateEmp(e);
	}
