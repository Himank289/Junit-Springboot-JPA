...
public class DemoApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Faculty f1=new Faculty("shiv sharma",9,LocalDate.now(),l1);
		fr.save(f1);
		
		
		
		f=fr.findById(4);
		List<Faculty> lst1=cr.findFacultyOfCourse(c.getCourseId());
		System.out.println("faculty teaching courses");
